...
// const pifyBasicCaps = { ...pifyBasic }; // via (https://www.codementor.io/@junedlanja/copy-javascript-object-right-way-ohppc777d_)

// const capitalize = arr => {
//   for (i = 0; i < arr.length; ++i) {
//     return arr[i].charAt(0).toUpperCase() + arr[i].slice(1);
//   }
// };

// capitalize(pifyBasicCaps.keys);
// console.log(pifyBasicCaps);

mxmTitle = "[suck my] Juice (I'm a ho)";
